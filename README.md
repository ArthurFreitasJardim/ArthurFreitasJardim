...
<div align="justify">
Hello! I’m <code>Arthur</code>, a 19-year-old from Belo Horizonte. I first discovered programming in 2020 through the technical high school program at <a href="https://www.cotemig.com.br/?pht=53101598905687976&keyword=cotemig&gad_source=1&gclid=CjwKCAjwk8e1BhALEiwAc8MHiPtsnaWmqXoGbG5EjlQFF5Q7rVjYAqvaJbRO8HwqTs95GlMSf2KQ0xoCSQUQAvD_BwE" target="_blank">COTEMIG</a>. During this time, I learned languages such as PHP, JavaScript, Kotlin, Swift, SQL, HTML, and CSS, as well as frameworks like Node.js and React. Although I didn't work in the industry during that period, I completed several projects that helped solidify my skills.

In October 2024, I began my first internship at <a href="https://www.linkedin.com/company/leaderrh-gest-o-estrat-gica-de-recursos-humanos/posts/?feedView=all" target="_blank">Leader RH</a>, where I'm starting to develop my own software and integrate files with the cloud.

After graduating from high school, I enrolled at <a href="https://www.pucminas.br/destaques/Paginas/default.aspx?utm_source=google&utm_medium=cpa&utm_campaign=aon-institucional&utm_content=PC00002&gad_source=1&gclid=CjwKCAjwk8e1BhALEiwAc8MHiJ66s56joN9L6Kuvbl90gkXUs0P3SBC0DVm4dBxJ1eJjZ6Ne838X5BoClk4QAvD_BwE" target="_blank">PUC Minas</a>, pursuing a Bachelor's Degree in Software Engineering to enhance my knowledge. Here, I was introduced to C and, especially, Java, which became the foundation of my studies. I also improved my JavaScript skills and learned agile methodologies, architectural patterns like MVC and DAO, complexity analysis, operating systems, and Git usage. At PUC, I worked on various projects, including the development of an e-commerce platform for a pharmacy in collaboration with a real client.
</div>
